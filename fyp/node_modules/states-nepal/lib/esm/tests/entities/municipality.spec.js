import { Municipality } from '../../src/entities/municipality';
...
describe('Test Municipality entities', () => {
    ...
    it('should test municipalities categories', () => {
        ...
        set.forEach(id => {
            ...
            const result = municipality && range(1, 4).includes(municipality.category_id);
    ...
    it('should test municipalities districts', () => {
        ...
        set.forEach(id => {
            const municipality = _municipality.find(id);
            const result = municipality && range(1, 77).includes(municipality.district_id);
            expect(result).toBeTruthy();
        });
    });
