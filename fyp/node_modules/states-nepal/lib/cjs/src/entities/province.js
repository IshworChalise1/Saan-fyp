...
class Province {
    ...
    constructor(lang = 'en') {
        try {
            this.lang = lang;
            this.provinces = (0, fetchers_1.fetcher)('provinces', this.lang);
        }
        catch (err) {
    ...
    largest() {
        ...
        let numericArea = [];
        if (this.lang === 'np') {
            numericArea = areas.map(el => (0, utils_1.numericEnglish)(el)).map(i => Number(i));
        }
    ...
    getProvincesWithDistricts() {
        const district = new district_1.District(this.lang);
    ...
    getProvincesWithDistrictsWithMunicipalities() {
        const district = new district_1.District(this.lang);
        const municipality = new municipality_1.Municipality(this.lang);
        const provinces = this.provinces;
